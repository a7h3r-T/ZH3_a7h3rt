...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\Users\\a7h3rt\\source\\repos\\ZH3_a7h3rt\\WinFormsApp1\\Database1.mdf;Integrated Security=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Course>(entity =>
        {
            entity.HasKey(e => e.CourseSk).HasName("PK__Course__C92D8C488FF79DD3");
        ...
        {
            entity.HasKey(e => e.DayId).HasName("PK__Day__BF3DD825C93B2EF0");
        ...
        {
            entity.HasKey(e => e.EmployementId).HasName("PK__Employem__BFBFF076B22F703F");
        ...
        {
            entity.HasKey(e => e.InstructorSk).HasName("PK__Instruct__9D017A2890ADD746");
        ...
        {
            entity.HasKey(e => e.LessonSk).HasName("PK__Lesson__B08512E262B5DB08");
        ...
        {
            entity.HasKey(e => e.RoomSk).HasName("PK__Room__328616CFC06ACD3B");
        ...
        {
            entity.HasKey(e => e.StatusId).HasName("PK__Status__C8EE20433511A356");
        ...
        {
            entity.HasKey(e => e.TimeId).HasName("PK__Time__E04ED967A3CEEEC8");
